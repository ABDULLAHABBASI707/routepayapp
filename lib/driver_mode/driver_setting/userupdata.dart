...
class DriverMyAppuserup extends StatefulWidget {
  DriverMyAppuserup({Key? key}) : super(key: key);

  @override
  _DriverMyAppuserupState createState() => _DriverMyAppuserupState();
}

class _DriverMyAppuserupState extends State<DriverMyAppuserup> {
  bool loading = false;
  ...
  Future<String> uploadImage(File image) async {
    ...
    var reference =
        FirebaseStorage.instance.ref('driverreg').child('driverreg_$filename');
