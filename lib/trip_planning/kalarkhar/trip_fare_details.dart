...
class KalarKahrTripFareScreen extends StatefulWidget {
  const KalarKahrTripFareScreen({Key? key}) : super(key: key);

  @override
  State<KalarKahrTripFareScreen> createState() => _TripFareScreenState();
}

class _TripFareScreenState extends State<KalarKahrTripFareScreen> {
