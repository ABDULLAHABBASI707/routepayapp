...
class KashmirTripFareScreen extends StatefulWidget {
  const KashmirTripFareScreen({Key? key}) : super(key: key);

  @override
  State<KashmirTripFareScreen> createState() => _TripFareScreenState();
}

class _TripFareScreenState extends State<KashmirTripFareScreen> {
