...
class SwatTripFareScreen extends StatefulWidget {
  const SwatTripFareScreen({Key? key}) : super(key: key);

  @override
  State<SwatTripFareScreen> createState() => _TripFareScreenState();
}

class _TripFareScreenState extends State<SwatTripFareScreen> {
